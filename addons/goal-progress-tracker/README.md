...
A InvestWise addon that helps you visualize your investment progress towards
financial goals using an interactive calendar-style representation.

## Features

- **Goal Integration**: Seamlessly integrates with your existing InvestWise
...
1. **Select a Goal**: Choose from your existing InvestWise goals using the
...
3. Install in InvestWise through the addon settings page
...
- Integrate with the InvestWise sidebar navigation and routing system
...
MIT License - see the main InvestWise project for details.
