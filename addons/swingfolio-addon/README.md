...
A comprehensive InvestWise addon for tracking and analyzing swing trading
...
1. Download the addon package from the InvestWise addon marketplace
2. Install through the InvestWise addon manager
...
- All preferences and selections are stored securely using InvestWise's
  encrypted storage
- No data is transmitted outside of your InvestWise instance
...
- Visit the InvestWise community forums
- Submit issues through the addon feedback system
- Check the InvestWise documentation for addon troubleshooting
