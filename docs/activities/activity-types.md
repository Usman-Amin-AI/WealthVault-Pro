...
InvestWise. Understanding these types is essential for creating activities
...
| **DEPOSIT**        | Incoming funds from outside InvestWise.                                                                | Increases cash             | –                               |
...
| **TRANSFER_IN**    | Move cash or assets into this account from another InvestWise account (asset cost basis preserved).    | Increases cash or quantity | Increases quantity for assets   |
...
Activities can be inserted retroactively; InvestWise recalculates balances
automatically.
