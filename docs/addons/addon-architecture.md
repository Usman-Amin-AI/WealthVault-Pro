# InvestWise Addon Architecture

A straightforward explanation of how InvestWise's addon system works.

## What Are InvestWise Addons?

Addons are TypeScript modules that extend InvestWise's functionality. Each
...
│                                                                 │
│  ┌─────────────────┐              ┌─────────────────┐           │
│  │ InvestWise App │◀─ discover ─▶│ Dev Server      │           │
│  │                 │              │ localhost:3001  │           │
│  │ • Auto-discover │              │                 │           │
│  │ • Load addons   │              │ /health    ✓    │           │
│  │ • Hot reload    │              │ /status    ✓    │           │
