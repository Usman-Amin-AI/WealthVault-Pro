...
- Node.js 20+ and pnpm
- InvestWise desktop app (optional but recommended: running in development mode
  for live reload and testing)
- Basic TypeScript and React knowledge
- Code editor (VS Code recommended)

## Start InvestWise (Recommended)

For the best development experience with live reload and testing, start
InvestWise in addon development mode:

```bash
# Clone InvestWise repository (if not already done)
...
cd ~/Documents/InvestWiseAddons

# Create addon using CLI
npx @investwise/addon-dev-tools create hello-world-addon
...
```json
{
  ...
  "version": "1.0.0",
  "description": "My first InvestWise addon",
  "author": "Your Name",
  "permissions": {
    "category": "ui",
...
function HelloWorldPage() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-4">Hello InvestWise</h1>
...
```
InvestWise Addon Development Server
...
Verify in InvestWise:

1. Open InvestWise in addon development mode with
   `VITE_ENABLE_ADDON_DEV_MODE=true pnpm tauri dev`
...
import type { AddonContext, Account } from '@investwise/addon-sdk';
...
function HelloWorldPage({ ctx }: { ctx: AddonContext }) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Hello InvestWise</h1>
          ...
          <div>
            ...
            {accounts.length > 0 ? (
              ...
              <p className="text-muted-foreground">
                No accounts found. Add an account in InvestWise to see data.
              </p>
            )}
          </div>
        )}
...
- CORS configured for InvestWise
...
- [Examples](https://github.com/afadil/investwise/tree/main/addons/) - Real
