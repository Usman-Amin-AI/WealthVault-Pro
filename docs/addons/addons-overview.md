InvestWise addons are TypeScript modules that extend the application's
...
## What are InvestWise Addons?

Addons are TypeScript/React-based extensions that provide access to
InvestWise's financial data and UI system.
...
directly into InvestWise's interface.
...
npm install -D @investwise/addon-dev-tools typescript vite
```

### Core Dependencies

- **@investwise/addon-sdk**: TypeScript types and API definitions
- **@investwise/ui**: UI components based on shadcn/ui and Tailwind CSS
- **@investwise/addon-dev-tools**: CLI and development server
...
Addons have access to InvestWise's UI component library:

```typescript
import { Button, Card, Dialog, Input, Table } from '@investwise/ui';
import { AmountDisplay, GainAmount, CurrencyInput } from '@investwise/ui/financial';
...
InvestWise Store, contact **investwise@teymz.com**.
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
  ...
  <Card href="https://github.com/afadil/investwise/tree/main/addons/">
  ...
  <Card href="https://investwise.app/addons">
