...
export interface AddonManifest {
  ...
  license?: string;
  /** Minimum InvestWise version required */
  minInvestWiseVersion?: string;
...
export interface AddonUpdateInfo {
  ...
  /** Minimum InvestWise version required for this update */
  minInvestWiseVersion?: string;
}
...
export interface AddonStoreListing {
  ...
  /** Number of reviews */
  reviewCount?: number;
  /** Whether it's verified by InvestWise team */
  verified?: boolean;
  /** Last update date */
  lastUpdated?: string;
