...
InvestWise's shared UI component library built on top of shadcn/ui and Tailwind
CSS.

## Overview

The `@investwise/ui` package provides a complete design system for InvestWise
...
- 💰 **InvestWise-specific components** - Financial data display components
...
```tsx
import { Button, Card, CardContent } from "@investwise/ui";
...
```tsx
import { AmountDisplay, GainAmount, GainPercent } from "@investwise/ui";
...
```tsx
// Import components
import { Button, Card, CardContent, AmountDisplay } from "@investwise/ui";

// Import styles (once in your main file)
import "@investwise/ui/styles";
...
All standard shadcn/ui components with InvestWise's Flexoki theme applied:
...
- Main application
- All addons using `@investwise/ui`
...
3. Customize if needed for InvestWise
...
1. Always import from `@investwise/ui` instead of creating custom components
...
This strategy ensures consistent UI/UX across the entire InvestWise ecosystem
