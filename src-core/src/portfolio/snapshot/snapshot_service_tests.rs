...
mod tests {
    ...
    impl AccountRepositoryTrait for MockAccountRepository {
        fn get_by_id(&self, id: &str, _profile_id: &str) -> AppResult<Account> {
            self.accounts
                .read()
                .unwrap()
                .get(id)
        ...
        async fn update(&self, _account_update: AccountUpdate, _profile_id: &str) -> AppResult<Account> {
            unimplemented!("MockAccountRepository::update")
        }
        async fn delete(&self, _id: &str, _profile_id: &str) -> AppResult<usize> {
    ...
    impl ActivityRepositoryTrait for MockActivityRepository {
        fn get_activity(&self, _activity_id: &str, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        fn get_activities(&self, _profile_id: &str) -> AppResult<Vec<Activity>> {
            unimplemented!()
        }
        fn get_activities_by_account_id(&self, _account_id: &str, _profile_id: &str) -> AppResult<Vec<Activity>> {
            unimplemented!()
        }
        ...
        fn get_trading_activities(&self, _profile_id: &str) -> AppResult<Vec<Activity>> {
            unimplemented!()
        }
        fn get_income_activities(&self, _profile_id: &str) -> AppResult<Vec<Activity>> {
            unimplemented!()
        }
        ...
        async fn create_activity(&self, _new_activity: NewActivity, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        async fn update_activity(&self, _activity_update: ActivityUpdate, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        async fn delete_activity(&self, _activity_id: String, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        ...
        async fn create_activities(&self, _activities: Vec<NewActivity>, _profile_id: &str) -> AppResult<usize> {
            unimplemented!()
        }
        ...
        fn calculate_average_cost(&self, _account_id: &str, _asset_id: &str, _profile_id: &str) -> AppResult<Decimal> {
            unimplemented!()
        }
        fn get_income_activities_data(&self, _profile_id: &str) -> AppResult<Vec<ActivityIncomeData>> {
            unimplemented!()
        }
        fn get_first_activity_date_overall(&self, _profile_id: &str) -> AppResult<DateTime<Utc>> {
            unimplemented!()
        }
    }
    ...
    impl ActivityRepositoryTrait for MockActivityRepositoryWithData {
        fn get_activity(&self, activity_id: &str, _profile_id: &str) -> AppResult<Activity> {
            self.activities
                .iter()
        ...
        fn get_activities_by_account_id(&self, account_id: &str, _profile_id: &str) -> AppResult<Vec<Activity>> {
            Ok(self
                .activities
                .iter()
        ...
        async fn create_activity(&self, _n: NewActivity, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        async fn update_activity(&self, _u: ActivityUpdate, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        async fn delete_activity(&self, _id: String, _profile_id: &str) -> AppResult<Activity> {
            unimplemented!()
        }
        async fn bulk_mutate_activities(
            &self,
        ...
        async fn create_activities(&self, _a: Vec<NewActivity>, _profile_id: &str) -> AppResult<usize> {
            unimplemented!()
        }
        fn get_first_activity_date(
            &self,
        ...
        fn get_import_mapping(&self, _id: &str, _profile_id: &str) -> AppResult<Option<ActivityImportMapping>> {
            Ok(None)
        }
        async fn save_import_mapping(&self, _m: &ActivityImportMapping) -> AppResult<()> {
            Ok(())
        }
        fn calculate_average_cost(&self, _acc: &str, _asset: &str, _profile_id: &str) -> AppResult<Decimal> {
            unimplemented!()
        }
        fn get_income_activities_data(&self, _profile_id: &str) -> AppResult<Vec<ActivityIncomeData>> {
            unimplemented!()
    ...
    fn create_test_account(id: &str, currency: &str, name: &str, profile_id: &str) -> Account {
        Account {
            id: id.to_string(),
            name: name.to_string(),
    ...
    async fn test_calculate_total_portfolio_snapshots_aggregation() {
        ...
        let acc1_cad = create_test_account("acc1", "CAD", "CAD Account", profile_id);
        let acc2_usd = create_test_account("acc2", "USD", "USD Account", profile_id);
        ...
        let result = snapshot_service.calculate_total_portfolio_snapshots(profile_id).await;
    ...
    async fn total_portfolio_snapshot_merges_lots() {
        ...
        let mut mock_account_repo_instance = MockAccountRepository::new();
        let profile_id = "default_profile";
        let acc1 = create_test_account("acc1", "USD", "USD Account 1", profile_id);
        let acc2 = create_test_account("acc2", "USD", "USD Account 2", profile_id);
    ...
    async fn test_calculate_holdings_snapshots_persists() {
        ...
        let acc = create_test_account("acc1", "CAD", "Test ACC", "default_profile");
        ...
        let saved = svc.calculate_holdings_snapshots(None, "default_profile").await.unwrap();
    ...
    async fn test_calculate_holdings_snapshots_persists_keyframes() {
        ...
        let mut account_repo = MockAccountRepository::new();
        let acc = create_test_account("acc1", "CAD", "Cash‑Only", "default_profile");
        account_repo.add_account(acc.clone());
