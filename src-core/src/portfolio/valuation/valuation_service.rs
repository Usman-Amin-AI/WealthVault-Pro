...
impl ValuationServiceTrait for ValuationService {
    async fn calculate_valuation_history(
        ...
        if recalculate_all {
            self.valuation_repository
                .delete_valuations_for_account(account_id, profile_id)
                .await?;
        } else {
            let last_saved_date_opt = self
                .valuation_repository
                .load_latest_valuation_date(account_id, profile_id)?;
        ...
        let snapshots_to_process = self
            .snapshot_service
            .get_daily_holdings_snapshots(account_id, calculation_start_date, None, profile_id)
            .map_err(|e| {
    ...
    fn get_latest_valuations(
        ...
        self.valuation_repository.get_latest_valuations(account_ids, profile_id)
    }
    ...
    fn get_valuations_on_date(
        ...
        self.valuation_repository
            .get_valuations_on_date(account_ids, date, profile_id)
    }
}
