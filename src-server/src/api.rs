...
#[openapi(
    paths(healthz, readyz, accounts::list_accounts, accounts::create_account, accounts::update_account, accounts::delete_account,
            relay::create_pair, relay::push_blob, relay::poll_blobs, relay::delete_pair,
            addon_registry::publish_manifest, addon_registry::list_addons, addon_registry::audit_manifest,
            addon_upload::upload_addon),
    components(schemas(Account, NewAccount, AccountUpdate, addon_registry::AddonManifest)),
...
pub fn app_router(state: Arc<AppState>, config: &Config) -> Router {
    ...
    // include relay endpoints in docs
    let _ = relay::router();
    ...
    let protected_api = Router::new()
        ...
        .merge(sync::router())
        .merge(relay::router())
        .merge(addon_registry::router())
        .merge(addon_upload::router())
