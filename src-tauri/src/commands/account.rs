...
use serde_json::json;
use investwise_core::accounts::{Account, AccountUpdate, NewAccount};
...
pub async fn get_accounts(state: State<'_, Arc<ServiceContext>>) -> Result<Vec<Account>, String> {
    ...
    state
        .account_service()
        .get_all_accounts("default_profile")
...
pub async fn update_account(
    ...
    let updated_account = state
        .account_service()
        .update_account(account_update.clone(), "default_profile") // Removed .await
...
pub async fn delete_account(
    ...
    state
        .account_service()
        .delete_account(&account_id, "default_profile")
        .await // Add .await here
        .map_err(|e| {
