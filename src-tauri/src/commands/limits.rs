...
pub async fn get_contribution_limits(
    ...
    state
        .limits_service()
        .get_contribution_limits("default_profile")
...
pub async fn update_contribution_limit(
    ...
    let updated_limit = state
        .limits_service()
        .update_contribution_limit(&id, updated_limit, "default_profile")
        .await
...
pub async fn delete_contribution_limit(
    ...
    state
        .limits_service()
        .delete_contribution_limit(&id, "default_profile")
        .await
...
pub async fn calculate_deposits_for_contribution_limit(
    ...
    state
        .limits_service()
        .calculate_deposits_for_contribution_limit(&limit_id, &base_currency, "default_profile")
