...
use investwise_core::fx::fx_model::{ExchangeRate, NewExchangeRate};
use investwise_core::settings::{Settings, SettingsUpdate};
...
pub async fn is_auto_update_check_enabled(
    ...
    state
        .settings_service()
        .is_auto_update_check_enabled("default_profile")
...
pub async fn update_settings(
    ...
    service
        .update_settings(&settings_update, "default_profile")
        .await
