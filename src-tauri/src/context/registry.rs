...
use investwise_core::{
    self, accounts, activities, assets, brokers::service::BrokerService, fx, goals, limits,
    market_data, portfolio, profiles::profiles_service::ProfileService, settings,
};
...
impl ServiceContext {
    ...
    pub fn broker_service(&self) -> Arc<BrokerService> {
        Arc::clone(&self.broker_service)
    }
}
