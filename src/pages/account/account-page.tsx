...
import { Icons, type Icon } from "@investwise/ui";
...
import { BrokerConnectionButton } from "../settings/accounts/components/broker-connection-button";
        ...
        actions={
          <>
            <div className="hidden items-center gap-2 sm:flex">
              <BrokerConnectionButton accountId={id} profileId={account?.profileId} />
              <Button
                variant="outline"
                size="icon"
