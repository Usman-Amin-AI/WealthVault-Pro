    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center gap-4">
          <img src="/logo.svg" alt="InvestWise logo" className="h-12 w-12 rounded-md shadow" />
          <div className="flex flex-col">
            <CardTitle className="text-xl">InvestWise</CardTitle>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                <a href="https://investwise.app" target="_blank" rel="noreferrer noopener">
              ...
              >
                <a
                  href="https://investwise.app/docs/introduction/"
                  target="_blank"
              ...
              >
                <a
                  href="https://github.com/afadil/investwise"
                  target="_blank"
                  rel="noreferrer noopener"
                >
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground text-sm">
              ...
              <span className="font-mono font-semibold select-all">investwise@teymz.com</span>
            </p>
            <div className="flex flex-wrap items-center gap-2">
              <Button
                asChild
                ...
                className="inline-flex items-center gap-2"
              >
                <a href="mailto:investwise@teymz.com">
                  <Icons.ExternalLink className="h-4 w-4" />
                  Email Us
                </a>
              </Button>
              ...
              >
                <a
                  href="https://github.com/afadil/investwise/issues"
                  target="_blank"
                  rel="noreferrer noopener"
                >
            ...
            <p className="text-muted-foreground text-sm">
              <a
                href="https://investwise.app/legal/privacy-policy"
                target="_blank"
                rel="noreferrer noopener"
              ...
              <a
                href="https://investwise.app/legal/terms-of-use"
                target="_blank"
                rel="noreferrer noopener"
                className="hover:text-foreground underline underline-offset-4"
              >
