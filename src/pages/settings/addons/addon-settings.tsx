    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <SettingsHeader
          ...
          text="Install and manage add-ons to extend InvestWise's functionality."
        />
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Add-ons let you extend InvestWise with new features, custom analytics, and
            ...
            {isLoadingAddons ? (
              ...
              <EmptyPlaceholder>
                ...
                <EmptyPlaceholder.Description>
                  Get started by installing your first add-on to extend InvestWise&apos;s
                  functionality.
                </EmptyPlaceholder.Description>
